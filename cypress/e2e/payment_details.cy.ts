describe("[Alma] Payment Details", () => {
  it("displays payments details when visiting /payments/<id>", () => {
    ...
    cy.visit("/payments/payment_121IopV7OU4kX5pMradVJfGAQzSJz7MGy2");
    ...
    cy.findByTestId("payment-details-header").should("be.visible");
    cy.findByTestId("purchase-amount").should("be.visible");
    cy.findByTestId("amount-left-to-pay").should("be.visible");
    cy.findByTestId("next-installment").should("be.visible");
    cy.findByTestId("creditcard-info").should("be.visible");
  ...
  it("shows an error state when payments API fails", () => {
    ...
    cy.visit("/payments/payment_121IopV7OU4kX5pMradVJfGAQzSJz7MGy3");
